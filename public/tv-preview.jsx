                                  ...
                                  {procedures.length>0&&(
                                    <div style={{display:"grid",gridTemplateColumns:`repeat(${procedures.length>=10?4:3},1fr)`,gap:"4px"}}>
                                      {sortProcedures(procedures).map(p=>(
                                        <span key={p.code} style={{display:"block",width:"100%",boxSizing:"border-box",textAlign:"center",padding:"4px 12px",borderRadius:"10px",fontSize:"clamp(20px,2vw,28px)",fontWeight:800,letterSpacing:"0.04em",lineHeight:1.2,whiteSpace:"nowrap",
